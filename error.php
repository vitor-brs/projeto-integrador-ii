                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-block bg-dark">
                        <div class="col-6 w-auto p-3 text-center text-white fw-light">
                            ...
                            <br>
                            <img src="img/error.jpg" width="100%" height="100%">
                            <p>
                                <br><br>
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                ...
                                <h1 class="h4 fw-light mb-4"> Acesso negado!</h1>
                            </div>
                            
                                <p class="text-center">Você precisa estar autenticado para acessar essa página!</p>

                                <div class="text-center">
                                    <a class="small" href="login.php">Clique aqui para voltar a página de login.</a>
                                </div>
